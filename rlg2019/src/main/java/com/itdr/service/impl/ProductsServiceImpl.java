...
public class ProductsServiceImpl implements ProductsService {
    ...
    //获取商品详情
    @Override
    public ServiceResponse<Products> detail(Integer productId, Integer is_new, Integer is_hot, Integer is_banner) throws IOException {
        ...
        ProductVO pro = PoToVoUtil.ProductToProductVO(product);
