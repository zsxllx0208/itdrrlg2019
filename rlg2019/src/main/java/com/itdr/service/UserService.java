...
public interface UserService {
    ...
    //登录中状态重置密码
    ServiceResponse resetPassword(String passwordOld, String passwordNew, Integer id);
    ...
    ServiceResponse<Users> forgetResetPassword(String username, String passwordNew, String forgetToken);
}
